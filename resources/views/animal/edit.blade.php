    ...
    <div class="card">
        <div class="card-header">
            <div class="row align-items-center">
                <div class="col-8">
                    <h3 class="mb-0">Editar Animal</h3>
                </div>
            </div>
        </div>
        <div class="card-body">
            
            <form action="{{ route('animal.atualizar', $animal['id_animal']) }}" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" id="input-nome" class="form-control" name="nome" value="{{ $animal['nome'] }}" required>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" id="input-identificacao" class="form-control" name="identificacao" value="{{ $animal['identificacao'] }}" required>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="date" id="input-data-nascimento" class="form-control" name="data_nascimento" value="{{ $animal['data_nascimento'] }}" required>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" id="input-cor" class="form-control" name="cor" value="{{ $animal['cor'] }}" required>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" id="input-microchip" class="form-control" name="microchip" value="{{ $animal['microchip'] }}">
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="date" id="input-data-implantacao" class="form-control" name="data_implantacao" value="{{ $animal['data_implantacao'] }}">
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" id="input-local-implantacao" class="form-control" name="local_implantacao" value="{{ $animal['local_implantacao'] }}">
                            </div>
                        </div>
                    </div>
